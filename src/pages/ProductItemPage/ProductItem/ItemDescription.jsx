...
const ItemDescription = ({ productItem }) => {
	...
	// TODO - Add a toast on click of this, to alert user what is being done
	const handleMinus = () => {
		const newState = productQuantityChosen - 1;
	...
	return (
		<article className="mt-[2.5rem] flex max-w-[50rem] flex-col md:mt-0 md:gap-[1rem]">
			<div className="flex items-center justify-between lg:w-[90%]">
				<div>
					<h2 className="text-[2.5rem] font-[600] lg:text-[4rem]">{productItem.brand}</h2>
					<StarRating
			...
			<div className="mt-[2rem]">
				<h2 className="text-[2.5rem] font-[600] lg:text-[4rem]">Description</h2>
				<p className="mt-[0.4rem] text-[1.5rem] font-[300] lg:text-[1.7rem]">
			...
			<div className="mt-auto flex justify-center gap-[3rem] font-[500] md:justify-between">
				<Button
					theme={'secondary'}
					variant={'shop'}
					className={
						'w-[15rem] p-[1rem_0] transition-[transform] duration-[200ms] ease-in-out  [box-shadow:0_0_0_1.3px_var(--color-secondary)] hover:scale-[1.1] hover:bg-heading hover:text-primary hover:[box-shadow:0_0_0_1.3px_var(--color-primary)] active:scale-[1.1]'
					}
				>
					<p>Buy Now</p>
				</Button>
				...
				<Button
					...
					variant={'shop'}
					className={
						'w-[15rem] p-[1rem_0] transition-[transform] duration-[200ms] ease-in-out [box-shadow:0_0_0_1.3px_var(--color-primary)] hover:scale-[1.1] hover:bg-heading hover:text-primary hover:[box-shadow:0_0_0_1.3px_var(--color-secondary)] active:scale-[1.17]'
					}
